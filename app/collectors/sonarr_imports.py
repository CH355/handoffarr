...
SOURCE = "sonarr"
MEDIA_TYPE = "series"
SUCCESS_EVENT_HINTS = tuple(IMPORT_SUCCESS_EVENTS | {"episodefileimported"})
FAILURE_EVENT_HINTS = tuple(IMPORT_FAILURE_EVENTS)
PATH_KEYS = ("droppedPath", "droppedRelPath", "sourcePath", "downloadPath", "path")
DESTINATION_KEYS = ("importedPath", "destinationPath", "episodeFilePath", "filePath")
...
def _file_path(record: dict[str, Any]) -> str | None:
    return nested_path(record, ("episodeFile", "file"))
